...
/**
 * Protocol class for clearing a specific area of the controller display screen.
 * Python equivalent: DisplayClear
 */
public class DisplayClear implements Serializable {
     ...
     */
    public DisplayClear(int x, int y, int width, int height, DisplayPixel pixel) {
        this.x = (short) x;
        this.y = (short) y;

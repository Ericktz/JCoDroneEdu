...
// BeforeEach removed in favor of try-with-resources inside tests
...
public class OpticalFlowTest {
    ...
    void testInvalidUnits_ThrowException() {
        runWithDrone(drone -> {
            ...
            assertThrows(IllegalArgumentException.class, () -> drone.getFlowVelocityX("invalid_unit"), "Should throw exception for invalid unit");

...
public class ControllerInputExample {
    public static void main(String[] args) {
        ...
        try (Drone drone = new Drone()) {
            ...
            System.out.println("int leftX = drone.getLeftJoystickX();    // Range: -100 to 100");
            System.out.println("int leftY = drone.getLeftJoystickY();    // Range: -100 to 100");
            System.out.println("int rightX = drone.getRightJoystickX();  // Range: -100 to 100");
            System.out.println("int rightY = drone.getRightJoystickY();  // Range: -100 to 100");
            System.out.println();
            ...
            System.out.println("Object[] buttonData = drone.getButtonData();");
            ...
            System.out.println();
            System.out.println("int[] joystickData = drone.getJoystickData();");
            ...
            System.out.println("boolean joysticksNeutral = Math.abs(drone.getLeftJoystickX()) < 5 &&");
            System.out.println("                          Math.abs(drone.getLeftJoystickY()) < 5 &&");
            System.out.println("                          Math.abs(drone.getRightJoystickX()) < 5 &&");
            System.out.println("                          Math.abs(drone.getRightJoystickY()) < 5;");
            ...
            System.out.println("  • getLeftJoystickX(), getLeftJoystickY()");
            System.out.println("  • getRightJoystickX(), getRightJoystickY()");
            System.out.println();
            System.out.println("Advanced Data:");
            System.out.println("  • getButtonData() - Complete button state information");
            System.out.println("  • getJoystickData() - Complete joystick state information");
